...
function [csarImage,xRangeT_m,zRangeT_m] = CSAR_1D_reconstructImage_2D_PFA_gpu(csarData,iParams,fParams,p)
...
if iParams.resize && (nargin == 4)
    csarImage = imresize(abs(csarImage),[p.xLim,p.zLim]);
    xRangeT_m = p.xT;
    zRangeT_m = p.zT;
end
