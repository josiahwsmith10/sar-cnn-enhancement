...
function [sarDataOut,phaseCorrectionFactor] = phaseCorrectionArbitraryArray(sarDataIn,iParams,fParams)
...
if ~iParams.CSAR
    ...
    %% Phase Correction
    %---------------------------------------------------------------------%
    phaseCorrectionFactor = exp(-1j* k .* iParams.D_m(:,2).^2 / (4*iParams.z0_mm*1e-3));
